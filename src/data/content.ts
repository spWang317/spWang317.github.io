...
export const research: {
...
}[] = [
  {
    ...
    summary: {
      ko: '한국어 초단편소설의 문장별 의미 흐름에서 다섯 가지 서사 유형과, 한 번 꺾였다 도약하는 패턴을 발견했습니다.',
      en: 'Found five narrative types in the sentence-level flow of Korean flash fiction, plus a recurring break-then-leap pattern.',
    },
  ...
  },
  {
    ...
    summary: {
      ko: '글이 의미 공간에서 그리는 궤적의 모양만으로 산문시와 초단편소설을 구분할 수 있음을 보였습니다.',
      en: 'Showed that prose poetry and flash fiction can be told apart purely from the shape of their trajectory through meaning space.',
    },
  ...
  },
  {
    ...
    summary: {
      ko: '사람이 쓴 초단편소설에서 9개 서사 원형을 추출해 한국어 언어 모델(Upstage)을 훈련하고, 생성된 글을 에이전트가 스스로 진단·재작성하는 파이프라인을 만들었습니다.',
      en: 'Extracted nine narrative archetypes from human-written flash fiction to train a Korean language model (Upstage); an agent then diagnoses and rewrites its own output.',
    },
  ...
  },
  {
    ...
    summary: {
      ko: '한국 전통 서사 구조(기승전결)와 서양 구조(Freytag)를 이야기 검색에서 비교해, 구조보다 질의를 얼마나 압축하느냐가 성능을 좌우함을 확인했습니다.',
      en: 'Compared a traditional Korean plot structure with a Western one for story retrieval, finding that query compression matters more than the structure itself.',
    },
  ...
  },
  {
    ...
    summary: {
      ko: '지상파·라디오 15개 채널 녹음에서 음성을 분리해 텍스트로 옮기는 파이프라인을 만들었습니다. 음악·잡음이 섞여도 안정적으로 작동합니다. (KOCCA)',
      en: 'Built a pipeline that separates and transcribes speech from 15 TV and radio channels, staying reliable even when music and noise overlap. (KOCCA)',
    },
  ...
  },
  {
    ...
    summary: {
      ko: '대규모 웹 이미지로 단어와 색상의 연관을 수치화하는 방법을 만들고, 글로벌 100대 브랜드와 20세기 영미시의 색채 상징에서 검증했습니다.',
      en: 'Developed a way to measure word–color association from large-scale web images, validated on the world’s top 100 brands and 20th-century Anglo-American poetry.',
    },
  ...
  },
  {
    ...
    summary: {
      ko: '한국 법령 전체(1948–2024)를 네트워크로 구성하고 법 사이 인용을 동조·상충으로 분류해, 2000년대 중반 특별법 증가로 법체계 정합성이 떨어졌음을 보였습니다.',
      en: 'Modeled all Korean law (1948–2024) as a network, classifying citations as reinforcing or conflicting, and showed coherence declined as special laws proliferated in the mid-2000s.',
    },
  ...
  },
  {
    ...
    summary: {
      ko: 'XR 협동 댄스 게임의 사용자 인식 조사를 맡아, 춤 관련 뉴스 1만 2천 건에서 사회적 인식 차이를 밝히고 게임 방향에 반영했습니다. (HCI Korea 2024)',
      en: 'Led the user-perception study for an XR co-op dance game, analyzing 12,000 dance-related news articles to inform the game’s direction. (HCI Korea 2024)',
    },
  ...
  },
  {
    ...
    summary: {
      ko: '죽음을 다룬 게임 〈Spiritfarer〉가 플레이어의 사별을 어떻게 위로하는지 인터뷰로 분석해, 상실과 회복을 오가는 감정 패턴을 밝혔습니다. (CHI EA 2021)',
      en: 'Studied how the death-themed game Spiritfarer helps players cope with loss, tracing through interviews how grief oscillates between loss and restoration. (CHI EA 2021)',
    },
